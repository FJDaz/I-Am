...
- ✅ Les tarifs sont les mêmes toute l'année pour chaque centre Non, les adresses et la liste sont les mêmes, les taifs sont dans /Users/francois-jeandazin/Documents/En Cours/Crea/NUX/I Amiens/data/raw/syn+tarif+2024+2025+pour+contrat (1).pdf
...
**Ton commentaire** : PDF ajouté `syn+tarif+2024+2025+pour+contrat (1).pdf` y a tous les tarifs là dedans, gros travail de rag à effectuer, groosse source
...
1. **Overpass API OSM** (requête fournie) :
   ...
   - ⚠️ Manque : téléphone, contacts, secteur administratif les secteuers sont présents sur la carte interactive, je t'ai filé un js mais je doute que ça t'aide beaucoup.
...
3. **Carte interactive** : `https://geo.amiens-metropole.com/adws/app/523da8c6-5dbc-11ec-9790-3dc5639e7001/index.html`
   - Données non ouvertes mais peut-être extractibles depuis le JS tu as vérifié qu'elles étaitent fermées ? je n'ai rien vu qui disaient qu'elles étaitent ouvertes mais ça ne veut pas dire autre c hose que ça .vérifie
...
1. **Endpoint autocomplete** : Comment récupérer les données ?
   ...
   - Option C : Fallback OSM + GOOG map + scraping manuel (si commande, là c'est poc)
